          ...
          {applications.length === 0 ? (
            ...
            <table style={styles.table}>
              ...
              <tbody>
                {applications.map(a => (
                  <tr key={a._id}>
                    <td style={styles.td}><strong style={{ color: theme.text }}>{a.offer_id?.title}</strong></td>
                    <td style={styles.td}>
                      {a.offer_id?.company_id ? (
                        <span style={styles.companyLink} onClick={() => handleViewCompany(a.offer_id.company_id)}>
