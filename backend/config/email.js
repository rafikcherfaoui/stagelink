...
<body style="font-family:sans-serif;background:#f5f7fa;margin:0;padding:20px;">
  <div style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0;">
    <div style="background:#0f1b2d;padding:24px 32px;">
      <div style="font-size:22px;font-weight:800;color:#fff;">Stage<span style="color:#0ea5a0;">Link</span></div>
    </div>
    ...
    <div style="background:#f5f7fa;padding:16px 32px;text-align:center;font-size:12px;color:#9aa5b4;">Université Saad Dahlab — Blida 1 · Plateforme StageLink</div>
  </div>
</body></html>`
...
<body style="font-family:sans-serif;background:#f5f7fa;margin:0;padding:20px;">
  <div style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0;">
    ...
    <div style="padding:32px;">
      ...
      <p style="color:#4a5568;line-height:1.7;">Ne vous découragez pas — de nombreuses autres opportunités vous attendent sur StageLink. Continuez à postuler !</p>
    </div>
    <div style="background:#f5f7fa;padding:16px 32px;text-align:center;font-size:12px;color:#9aa5b4;">Université Saad Dahlab — Blida 1 · Plateforme StageLink</div>
  </div>
</body></html>`
...
<body style="font-family:sans-serif;background:#f5f7fa;margin:0;padding:20px;">
  <div style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0;">
    ...
    <div style="padding:32px;">
      ...
      <p style="color:#4a5568;line-height:1.7;">Votre compte ${roleLabel} a été créé sur la plateforme StageLink de l'Université Saad Dahlab Blida 1.</p>
